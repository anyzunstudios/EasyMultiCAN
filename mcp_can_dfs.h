...
** Latest Version:             v0.1
** Descriptions:               mcp2515 class defineS file
**
**--------------------------------------------------------------------------------------------------------
** Created by:                 loovee
...
/*
 *  speed 8M (MCP2515 with 8MHz crystal)
 *  Required when the MCP2515 module uses an 8MHz oscillator.
 */
#define MCP_8MHz_500kBPS_CFG1  (0x00)
#define MCP_8MHz_500kBPS_CFG2  (0x90)
#define MCP_8MHz_500kBPS_CFG3  (0x02)

#define MCP_8MHz_250kBPS_CFG1  (0x01)
#define MCP_8MHz_250kBPS_CFG2  (0x90)
#define MCP_8MHz_250kBPS_CFG3  (0x02)
...
// ---------------------------------------------------------------------------
// Chip Select (CS/SS) pin selection
//
// - Default keeps backwards compatibility (UNO/most boards -> D10)
// - Mega2560 default -> D53 (hardware SS)
// - You can override from your sketch BEFORE including mcp_can.h:
...
// Keep legacy name used across this library
#define SPICS MCP2515_CS_PIN
...
// -----------------------------------------------------------------------------
// MCP2515 oscillator selection (for modules with 8MHz or 16MHz crystals)
// -----------------------------------------------------------------------------
#ifndef MCP_8MHZ
#define MCP_8MHZ  8
#endif
